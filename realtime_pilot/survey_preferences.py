...
DEVICES=[
 preference('P_AC_RANGE','夏季在家时，您家通常希望室温保持在哪个范围？（选择最接近的一项）',[(x,x.replace('_','—')+'℃') for x in ['18_20','20_22','22_24','23_25','24_26','25_27','26_28','28_30']],'preferred_room_temperature','ac'),
