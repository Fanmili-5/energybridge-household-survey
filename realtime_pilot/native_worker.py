...
def run(folder):
    ...
    files=('native_runner.py','native_clock.py','native_worker.py','native_presentation.py','native_assets.py','native_scenario.py','native_support.py','paired_contract.py','survey_time.py','survey_preferences.py',
           'household_config.py','planner_language.py','planner_english_catalog.json','proposal_contract.py','presentation.py','resource_limits.py','simulation_environment.py','date_sampling.py')
    ...
    for branch in ('baseline','proposal'):
        ...
        for name in ('planner_household_en.json','native_result.json','actuator_trace.json','appliance_clock.json','service_evidence.json','native_boundary_manifest.json','collection_entry.py','ep_metric_series.json','eplusout.err','eplusout.sql'):
