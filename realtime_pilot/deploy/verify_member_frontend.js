...
(async()=>{
 ...
 await page.evaluate(()=>showWizard(3,{save:false}));await page.locator('#research-consent').check();await page.locator('#scenario-understood').check();await page.locator('#generate').click();await page.waitForFunction(()=>document.getElementById('error').textContent.includes('模拟提交已捕获'));
